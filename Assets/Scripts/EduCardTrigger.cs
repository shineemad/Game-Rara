...
/// <summary>
/// EduCardTrigger — popup "Rara berhasil sampai" yang muncul otomatis saat
/// Rara melewati titik X tertentu. Style mengikuti popup sukses dengan judul
/// besar, angka poin emas, subtitel, dan tombol lanjut.
///
/// Cara pakai:
///   1. GameObject → Create Empty → "EduCardTrigger_Day1"
///   2. Add Component → EduCardTrigger
...
///   6. Hubungkan event onLanjut ke method scene berikutnya / kartu edukasi
/// </summary>
public class EduCardTrigger : MonoBehaviour
{
    // ══════════════════════════════════════════════════════════════════════
    // INSPECTOR
    // ══════════════════════════════════════════════════════════════════════
    ...
    [Header("Event")]
    [Tooltip("Dipanggil saat pemain klik tombol Lanjut (atau auto-close).")]
